...
async function main() {
  ...
  const lesson1 = await db.lesson.upsert({
    ...
    create: {
      ...
      contentPath: 'business/foundations/defining-a-business.md',
      order: 1,
    },
  })
    ...
    data: [
      {
        ...
        options: JSON.stringify([
          'It provides a product or service',
          'It must have at least 5 employees',
          'It operates with the intent to generate value',
          'It can exist as a one-person operation',
        ]),
  ...
  const lesson2 = await db.lesson.upsert({
    ...
    create: {
      ...
      contentPath: 'business/foundations/business-structures.md',
      order: 2,
    },
  })
    ...
    data: [
      {
        ...
        type: 'MULTIPLE_CHOICE',
        options: JSON.stringify([
          'LLCs pay less in taxes',
          'LLCs protect your personal assets from business debts',
          'LLCs are easier to set up',
          'LLCs do not require any paperwork',
        ]),
  ...
  await db.assessment.upsert({
    ...
    create: {
      ...
      questions: {
        create: [
          {
            question: 'A sole proprietorship offers personal liability protection for the owner.',
            type: 'MULTIPLE_CHOICE',
            options: JSON.stringify(['True', 'False']),
            correctAnswer: 'False',
            explanation: 'Sole proprietorships offer no liability protection — the owner is personally responsible for all business debts and legal issues.',
            points: 1,
            order: 1,
          },
          {
            question: 'Which business structure is typically best for a first-time solo business owner who wants liability protection without a lot of complexity?',
            type: 'MULTIPLE_CHOICE',
            options: JSON.stringify(['Corporation', 'LLC', 'Sole Proprietorship', 'Partnership']),
            correctAnswer: 'LLC',
            explanation: 'An LLC offers liability protection with less complexity and cost than a corporation, making it the most common choice for solo entrepreneurs.',
            points: 1,
            order: 2,
          },
          {
            question: 'Explain in your own words why keeping business and personal finances separate matters.',
            type: 'OPEN_ENDED',
            correctAnswer: 'Mixing personal and business finances makes bookkeeping difficult, can invalidate your LLC liability protection, complicates taxes, and makes it hard to understand if your business is actually profitable.',
            explanation: 'Separation protects your legal status, simplifies taxes, and gives you a clear picture of business health.',
            points: 2,
            order: 3,
          },
        ],
